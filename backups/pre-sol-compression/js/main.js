(function () {
  ...
  function updateHeroProgress() {
    ...
    if (heroProgress) heroProgress.textContent = progress > .66 ? '03 / 03' : (progress > .25 ? '02 / 03' : '01 / 03');
  }
  ...
  function populateDialog(projectNumber) {
    ...
    if (dialogImage) {
      ...
      dialogImage.width = project.width;
      dialogImage.height = project.height;
    }
    resetPaperLayers();
    animatePaperLayers(project.image);
  }
